...
// isConnected - флаг наличия датчика на шине
// uart - указатель на используемый датчиком uart
// serialNumber[] - id датчика
// temperatureLimitLow - нижний порог температуры
// temperatureLimitHigh - верхний порог температуры
// configRegister - разрешающая способность датчика
...
// Структура команды
// code - код команды
// rxBytesNum - кол-во байт для чтения после отправки команды
// txBytesNum - кол-во байт для передачи вслед за командой
...
// Проверка наличия датчика на линии
